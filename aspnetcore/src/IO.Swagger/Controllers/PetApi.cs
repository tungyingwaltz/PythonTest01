...
{ 
    ...
    { 
        ...
        [HttpPost]
        [Route("/team123a/test02/1.0.0/pet")]
        [ValidateModelState]
        ...
        [HttpDelete]
        [Route("/team123a/test02/1.0.0/pet/{petId}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/team123a/test02/1.0.0/pet/findByStatus")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/team123a/test02/1.0.0/pet/findByTags")]
        [ValidateModelState]
